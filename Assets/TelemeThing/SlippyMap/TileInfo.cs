...
public class TileInfoy : IEquatable<TileInfo>
{
    public float MapTileSize { get; private set; }

    public TileInfoy(WorldCoordinate centerLocation, int zoom, float mapTileSize)
    {
    ...
    public TileInfoy(int x, int y, int zoom, float mapTileSize)
    {
        SetStandardValues(mapTileSize);
        X = x;
        Y = y;
